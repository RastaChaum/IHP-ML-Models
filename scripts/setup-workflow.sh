...
echo ""
echo "  Allez sur : https://github.com/RastaChaum/IHP-ML-Models/settings/branches"
echo ""
...
cat << 'EOF'
  ...
  6. ❌ NE PAS activer "Require linear history"
  7. Save changes
  ...
  3. ✅ Require a pull request before merging
  4. ✅ Require status checks to pass (select: validate-pr)
